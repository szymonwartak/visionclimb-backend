...
libraryDependencies += "org.eclipse.jetty" % "jetty-webapp" % "8.1.8.v20121106" % "container"
...
libraryDependencies ++= {
  ...
  Seq(
    ...
    //"org.eclipse.jetty" % "jetty-webapp" % "8.1.8.v20121106" % "test" excludeAll(ExclusionRule(organization = "org.slf4j")),
